...
class Place(object):
    ...
    def add_insect(self, insect):
        ...
        if insect.is_ant:
            if self.ant is None:
                ...
                assert self.ant is None or (self.ant.container==True or insect.ant.container==True), 'Two ants in {0}'.format(self)
                # END Problem 7
        else:
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if self.ant is QueenAnt.true_queen:
                return None
            if self.ant!=None and self.ant.container==True and self.ant.ant!=None and self.ant.ant is QueenAnt.true_queen:
                return None
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while current_place.entrance.name != 'Hive' and current_place.entrance != None and count < self.max_range and len(current_place.bees) == 0 and current_place!=None:
            count += 1
            current_place = current_place.entrance
...
class FireAnt(Ant):
    ...
    def reduce_armor(self, amount):
        ...
        if self.armor<=amount:
            # self.place.bees[:]=[Insect.reduce_armor(self.damage) for Insect in self.place.bees if Insect.armor>self.damage]
...
class QueenAnt(ScubaThrower):  
    ...
    def action(self, colony):
        ...
        count = 0
        ants=[]
        while current_place!= None and current_place.entrance.name != 'Hive':
            if (current_place.ant!=None):
                if current_place.ant.container==True and current_place.ant.ant!=None:
                    ants.append(current_place.ant.ant)
                ants.append(current_place.ant)
